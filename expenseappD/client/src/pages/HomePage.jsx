        ...
        <Layout>
            ...
            <div className="filters">
                ...
                <Select value={frequency} onChange={(values)=>setFrequency(values)}>
                    ...
                    {frequency === 'custom' && <DatePicker.RangePicker value={selectedDate} onChange={(values)=>setSelectedate(values)}/>}
                    </div>
                ...
                <Select value={type} onChange={(values)=>setType(values)}>
                    ...
                    <div className='switch-icons'>
                        <UnorderedListOutlined className={`mx-2 ${viewData==='table' ? 'active-icon' :'inactive'}`} onClick={()=>setviewData('table')}/>
                        <AreaChartOutlined className={`mx-2 ${viewData==='analytics' ? 'active-icon' :'inactive'}`} onClick={()=>setviewData('analytics')}/>
